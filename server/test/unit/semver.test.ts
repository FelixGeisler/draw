...
describe("parseSemver", () => {
  it("parses a plain triple and tolerates the v prefix — GitHub tags are v-prefixed", () => {
  ...
  it("captures the prerelease identifiers", () => {
  ...
  it("returns null for anything that is not a full semver triple", () => {
...
describe("compareSemver", () => {
  it("treats the same version as equal regardless of the v prefix", () => {
  ...
  it("a prerelease precedes its release", () => {
...
describe("isUpdateAvailable", () => {
  it("offers a newer stable release, v-prefix tolerant on both sides", () => {
  ...
  it("the same version is never an update", () => {
    expect(isUpdateAvailable("1.0.0", "1.0.0")).toBe(false);
    expect(isUpdateAvailable("1.0.0", "v1.0.0")).toBe(false);
  });

  it("a running version NEWER than latest (a dev build) is never an update", () => {
  ...
  it("never offers a prerelease to a stable running version", () => {
  ...
  it("offers newer prereleases and the closing stable to a prerelease runner", () => {
  ...
  it("anything unparseable on either side is never an update", () => {
